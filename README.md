...
The site has four sections — Home, Photo, Prints, and About — all
...
- **Home** shows whichever photo is marked as the hero (from Photo or
  Prints).
- **Photo** and **Prints** are each a flat, ordered set of photos.
...
`/admin` is where all four sections get managed — Photo and Prints photos
